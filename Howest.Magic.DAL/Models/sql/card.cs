...
public class card
{
    ...
    [StringLength(255)] public string mana_cost { get; set; }

    [Required] [StringLength(255)] public string converted_mana_cost { get; set; }

    [Required] [StringLength(255)] public string type { get; set; }

    [StringLength(255)] public string rarity_code { get; set; }

    [Required] [StringLength(255)] public string set_code { get; set; }

    public string text { get; set; }
    public string flavor { get; set; }
    public long? artist_id { get; set; }

    [Required] [StringLength(255)] public string number { get; set; }

    [StringLength(255)] public string power { get; set; }

    [StringLength(255)] public string toughness { get; set; }

    [Required] [StringLength(255)] public string layout { get; set; }

    public int? multiverse_id { get; set; }

    [StringLength(255)] public string original_image_url { get; set; }

    [Required] [StringLength(255)] public string image { get; set; }

    public string original_text { get; set; }

    [StringLength(255)] public string original_type { get; set; }

    [Required] [StringLength(255)] public string mtg_id { get; set; }
